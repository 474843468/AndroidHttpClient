...
public class RocketAvatarsAnimator {
    ...
    private Animator getFlameAnimator(View targetView) {
        ...
        ObjectAnimator
            alphaAnimator = ObjectAnimator.ofFloat(targetView, View.ALPHA, 0f, 1f, 0.5f, 1f, 0.8f, 1f);
        ObjectAnimator
            scaleAnimator = ObjectAnimator.ofFloat(targetView, View.SCALE_Y, 0.8f, 1f, 0.9f, 1f, 0.7f, 1f);

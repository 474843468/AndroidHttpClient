 ...
 */
package com.psi.androidhttpclient.animator;
...
public class RocketFlightAwayAnimator {
    ...
    private AnimatorSet getTranslationAnimator(final View targetView) {
        ...
        animator.setDuration(1000);
        ObjectAnimator
            translationXAnimator = ObjectAnimator.ofFloat(targetView, View.TRANSLATION_X, -rootView.getWidth()/2, 0f);
        ObjectAnimator
            translationYAnimator = ObjectAnimator.ofFloat(targetView, View.TRANSLATION_Y, rootView.getWidth()/2, 0f);

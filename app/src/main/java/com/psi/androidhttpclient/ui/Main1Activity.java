...
public class Main1Activity extends BaseToolbarActivity1 {
  ...
  //
  //ToastUtils.showShort(Main1Activity.this, u.toString());
  //Logger.i(u.toString());
  ...
  private void checkIpEmpty(String ip) {
    if (ip == null || ip.toString().trim().equals("")) {
      Toast.makeText(Main1Activity.this, "请输入ip", Toast.LENGTH_SHORT).show();
      return;
    }
  }

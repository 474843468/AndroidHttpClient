...
import com.psi.androidhttpclient.eventBus.event.SessionOutEvent;
import com.psi.androidhttpclient.ui.fragment.ActivityManager;
import com.psi.androidhttpclient.ui.fragment.BroadcastConst;
import com.psi.androidhttpclient.ui.fragment.BussActivity;
import com.psi.androidhttpclient.ui.fragment.MainFragment;
...
public class MainActivity extends BussActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    filter.addAction(BroadcastConst.INTENT_ACTION_SERVICE_FAULT);
    filter.addAction(BroadcastConst.INTENT_ACTION_SERVICE_TIMEOUT);
 ...
 /*   public void setIsToHome(boolean isToHome){
  ...
  public static int getIndexByAction(String action){
    ...
    switch (action){
      case ACTION_HOME_TAB:return 0;
      case ACTION_INVEST_TAB:return 1;
      case ACTION_LIFE_TAB:return 2;
      case ACTION_MESSAGE_TAB:return 3;
      case ACTION_MINE_TAB:return 4;
    }
    return 0;
  }
}

...
public class BroadcastConst {
    ...
    public final static String INTENT_ACTION_SERVICE_TIMEOUT = "com.boc.bocsoft.bocmbovsa.SERVICE_TIMEOUT";

    public final static String INTENT_ACTION_SERVICE_FAULT = "com.boc.bocsoft.bocmbovsa.SERVICE_FAULT";
}

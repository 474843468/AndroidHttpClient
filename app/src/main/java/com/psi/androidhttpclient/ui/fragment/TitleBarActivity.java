...
import com.psi.androidhttpclient.widget.TitleBarView;
...
public class TitleBarActivity extends BaseActivity implements BaseViewInterface{
    ...
    protected View getTitleBarView(){
        mTitleBarView=new TitleBarView(mContext)
                .setStyle(getTitleBarRed()?R.style.titlebar_common_red :R.style.titlebar_common_white)//默认红色风格
                ...
                .setRightImgBtnVisible(isDisplayRightIcon());//设置右侧图片按钮是否显示

...
public class InstantTypeAdapter extends GsonTypeAdapter<Instant> {
  ...
  @Override public JsonElement serialize(final Instant src, final Type typeOfSrc,
      final JsonSerializationContext context) {
    String formatted = String.valueOf(src.toEpochMilli());
    return new JsonPrimitive(formatted);
  }

  @Override public Instant deserialize(final JsonElement json, final Type typeOfT,

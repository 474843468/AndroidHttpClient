...
public class LocalDateTimeTypeAdapter extends GsonTypeAdapter<LocalDateTime> {
  ...
  @Override public JsonElement serialize(final LocalDateTime src, final Type typeOfSrc,
  ...
  @Override public LocalDateTime deserialize(final JsonElement json, final Type typeOfT,

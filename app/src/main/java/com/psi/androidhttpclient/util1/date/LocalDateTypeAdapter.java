...
public class LocalDateTypeAdapter extends GsonTypeAdapter<LocalDate> {
  ...
  @Override public JsonElement serialize(final LocalDate src, final Type typeOfSrc,
  ...
  @Override public LocalDate deserialize(final JsonElement json, final Type typeOfT,

...
import com.psi.androidhttpclient.util1.AnimUtils;
import com.psi.androidhttpclient.widget.dialogview.BaseDialog;
 ...
 * <p>使用者可通过设置取消监听器{@link #setOnCancelListener(DialogInterface.OnCancelListener)}
 * 或者消失监听器{@link #setOnDismissListener(DialogInterface.OnDismissListener)}来监听对话框关闭事件
 *
